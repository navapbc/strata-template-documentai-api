...
def is_file_too_large_for_bda(content_type: str, file_size_bytes: int) -> bool:
    ...
    if content_type in ["image/jpeg", "image/png"]:
        return file_size_bytes > int(ConfigDefaults.BDA_MAX_IMAGE_SIZE_BYTES.value)
    elif content_type in ["application/pdf", "image/tiff"]:
        return file_size_bytes > int(ConfigDefaults.BDA_MAX_DOCUMENT_FILE_SIZE_BYTES.value)
    else:
