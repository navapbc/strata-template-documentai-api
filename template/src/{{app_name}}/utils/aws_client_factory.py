...
class AWSClientFactory:
    ...
    def get_session(cls) -> boto3.Session:
        if cls._session is None:
            ...
            cls._session = boto3.Session(profile_name=profile_name) if profile_name else boto3.Session()
    ...
    def get_bda_runtime_client(cls):
        return cls.get_session().client("bedrock-data-automation-runtime", region_name=cls._get_region())
