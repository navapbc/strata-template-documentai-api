...
from config.constants import CACHE_KEY_BLUEPRINT_SCHEMAS, CACHE_BLUEPRINT_SCHEMAS_TTL_MINUTES
from services.bda import get_data_automation_project, get_blueprint
...
def _fetch_schemas_from_bda() -> dict:
    ...
    try:
        ...
        blueprints = project_response.get("project", {}).get("customOutputConfiguration", {}).get("blueprints", [])
